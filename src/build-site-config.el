;; Org Blog Generator - Core Configuration
;; This file provides the default configuration for the blog generator.
;; Override any of these variables in your site-config.el file.
...
(defvar my-site-preamble
  ...
  "HTML preamble for public blog pages.")
...
(defvar my-private-site-preamble
  ...
  "HTML preamble for private blog pages.")

;; Default HTML head - can be overridden in site-config.el
(defvar my-html-head
...
"
  "HTML head content including CSS and JavaScript.")

;; Set org-html configuration
(setq org-html-validation-link nil
      org-html-head-include-scripts nil
      org-html-head-include-default-style nil
      org-html-head my-html-head
      org-html-preamble t
      org-html-preamble-format (list (list "en" my-site-preamble)))

;; ============================================================================
;; Core Publishing Functions - Generally should not need to override these
;; ============================================================================
